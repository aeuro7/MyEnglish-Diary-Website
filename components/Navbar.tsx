        ...
        >
            <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-2">
                    ...
                    <NavLink href="/manage" active={isActive('/manage')} label="Manage" />
                </div>
                ...
                <div className="flex md:hidden items-center gap-4">
                    ...
                    <Link href="/manage" className={`p-2.5 rounded-full transition-all duration-200 ${isActive('/manage') ? 'text-[var(--primary)] bg-red-50' : 'text-[var(--text-secondary)] hover:text-[var(--text-main)] hover:bg-black/5'}`}>
