...
export default function WordToMeaningPage() {
    ...
    const generateQuestion = (pool = gameVocabs) => {
        ...
        while (wrongOptions.length < 3 && attempts < 50) {
            ...
            const option = randomVocab.meaning;
            ...
            <div className="max-w-3xl mx-auto px-6">
                ...
                {gameState === 'idle' ? (
                    <div className="premium-card p-10 text-center reveal delay-100 max-w-lg mx-auto">
                        <div className="w-20 h-20 bg-purple-50 text-purple-500 rounded-[24px] flex items-center justify-center mx-auto mb-6 shadow-sm">
                            <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                        </div>
                        <h2 className="text-[22px] font-bold text-[var(--text-main)] mb-3">Word → Meaning</h2>
                    ...
                    <div className="reveal">
                        ...
                        <div className="grid gap-3 mb-10">
                            {options.map((option, i) => {
                                ...
                                const isAnswerCorrect = currentVocab?.meaning === option;
